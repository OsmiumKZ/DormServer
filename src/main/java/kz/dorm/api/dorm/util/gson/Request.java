...
public class Request {
    ...
    public Request(int id, long uin, String address, String phone, String group, int genderId, int number, int dormId, int children, String dateResidence, String nameF, String nameL, String patronymic) {
        this.id = id;
        this.uin = uin;
